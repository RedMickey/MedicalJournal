...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 05 2019 г., 14:40
...
('1_1', '1_1', 2, 1, '2019-02-04', NULL, 1, 10, 'лодлодо', 1, 2, NULL, 17),
('1_2', '1_2', 3, 2, '2019-02-03', NULL, NULL, NULL, 'орпорорпо', 1, 1, NULL, 17);
...
('1_1', 0, '2019-02-04 04:16:00', '1_1', NULL, NULL),
('1_2', 1, '2019-02-04 00:00:00', '1_1', NULL, NULL),
('1_3', 0, '2019-02-04 00:00:00', '1_2', NULL, NULL),
('1_4', 1, '2019-02-04 00:00:00', '1_2', NULL, NULL),
('1_5', 0, '2019-02-04 00:00:00', '1_2', NULL, NULL);
...
(18, '2019-01-31 18:34:39', 'testUser1', 'kek123', 'dsfsdf@kek6', '$2a$10$SUYDXpCLmeJfRdGllU2TfuS06xTZMKq30Bn/Rp/2gARnSuZuZCoe.', 1, 3, 1999),
...
--
-- Ограничения внешнего ключа таблицы `measurement_value_type`
--
ALTER TABLE `measurement_value_type`
  ADD CONSTRAINT `FK6pniipupf6sn5cdjoubr8tysa` FOREIGN KEY (`_id_measur_value_type`) REFERENCES `measurement_type` (`_id_measurement_type`);
