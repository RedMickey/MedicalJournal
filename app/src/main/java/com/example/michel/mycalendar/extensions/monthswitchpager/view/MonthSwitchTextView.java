package com.example.michel.mycalendar.extensions.monthswitchpager.view;
...
public class MonthSwitchTextView extends RelativeLayout {
    ...
    @BindView(android.R.id.icon1) ForegroundImageView mIconLeft;
    @BindView(android.R.id.icon2) ForegroundImageView mIconRight;
    @BindView(android.R.id.text1) TextView mTextTitle;
