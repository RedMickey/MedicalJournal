package com.example.michel.mycalendar.extensions.expandcalendar.view;
...
import com.example.michel.mycalendar.extensions.expandcalendar.adapter.MonthViewAdapter;
...
import com.example.michel.mycalendar.extensions.util.UiUtils;
...
public class ExpandCalendarView extends LinearLayout implements ExpandCalendarMonthView.OnDayClickListener {
    ...
    @BindView(android.R.id.content) ExpandMonthRecyclerView mRecyclerView;
    @BindView(android.R.id.button1) View mBtnView;
