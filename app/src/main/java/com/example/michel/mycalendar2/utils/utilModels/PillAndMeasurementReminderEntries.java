...
public class PillAndMeasurementReminderEntries {
    ...
    public PillAndMeasurementReminderEntries(){
        this.pillReminderEntries = new ArrayList<PillReminderEntry>();
        this.measurementReminderEntries = new ArrayList<MeasurementReminderEntry>();
    }
